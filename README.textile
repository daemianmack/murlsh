...
The config.yaml 'thumbnail_shortcuts' hash can be used to give symbolic
names to thumbnail image urls and those names can be passed in as the
'thumbnail' parameter when adding a url. The keys are the symbolic names
and the values are urls.
