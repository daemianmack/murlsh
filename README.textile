...
Create a fork on github and clone it out or clone public url:
...
Edit config.yaml, set 'root_url', 's3_bucket', 's3_id', and 's3_secret'
(for thumbnail storage). Other config is optional.
